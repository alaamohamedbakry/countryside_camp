            ...
            <form method="POST" action="{{ route('staff.update', $staff->id) }}">
                ...
                <div class="user-details">
                    <div class="input-box">
                        ...
                        <x-text-input value="{{ old('staff_name', $staff->staff_name) }}" class="w-full"
                            name='staff_name'></x-text-input>
                        @error('staff_name')
                    ...
                    <div class="input-box">
                        ...
                        <x-text-input value="{{ old('phone_number', $staff->phone_number) }}" class="w-full"
                    ...
                    <div class="input-box">
                        ...
                        <x-text-input value="{{ old('birthdate', $staff->birthdate) }}" class="w-full"
                        ...
                        <div>
                            ...
                            <select name="camp_id">
                                ...
                                @foreach ($camp as $camp)
                                    <option @selected($camp == $staff->camp) value="{{ $camp->id }}">
