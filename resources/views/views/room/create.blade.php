        ...
        <form enctype="multipart/form-data" method="POST" action="{{ route('room.store') }}"
            ...
            <div class="user-details">
                <div class="input-box">
                    ...
                    <x-text-input value="{{ old('room_number') }}" class="w-full" name='room_number'></x-text-input>
                    @error('room_number')
                        <x-input-label for='room_number' class="font-bold text-red-800">{{ $message }}</x-input-label>
                    @enderror
                </div>
                <div class="input-box">
                    <x-input-label for='capcity'>capcity</x-input-label>
                    <x-text-input value="{{ old('capcity') }}" class="w-full" name='capcity'></x-text-input>
                    @error('capcity')
                        <x-input-label for='room' class="font-bold text-red-800">{{ $message }}</x-input-label>
                    @enderror
                </div>
                <div class="input-box">
                ...
                <div class="input-box">
                    ...
                    <x-text-input value="{{ old('number_bed') }}" class="w-full" name='number_bed'></x-text-input>
                    @error('number_bed')
                        <x-input-label for='room' class="font-bold text-red-800">{{ $message }}</x-input-label>
                    @enderror
                </div>
