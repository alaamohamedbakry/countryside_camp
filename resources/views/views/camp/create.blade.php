...
<body>
    ...
    <div class="container">
        <h1>Camp Page</h1>
        <form method="POST" action="{{ route('camp.store') }}" class="p-2 border rounded-2xl">
            @csrf
            <div class="user-details">
                <div class="input-box">
                    <x-input-label for='camp_name'>camp_Name</x-input-label>
                    <x-text-input value="{{ old('camp_name') }}" class="w-full" name='camp_name'></x-text-input>
                    @error('camp_name')
                        <x-input-label for='camp_name' class="font-bold text-red-800">{{ $message }}</x-input-label>
                    @enderror
                </div>
                <div class="input-box">
                ...
                <div class="input-box">
                    ...
                    <x-text-input value="{{ old('group_of') }}" class="w-full" name='group_of'></x-text-input>
                    @error('group_of')
                        <x-input-label for='owner' class="font-bold text-red-800">{{ $message }}</x-input-label>
                    @enderror
                </div>
