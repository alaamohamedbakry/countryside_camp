...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content">
            <form method="POST" action="{{ route('buildings.update', $buildings->id) }}" class="border rounded-2xl p-2">
                @csrf
                @method('PATCH')
                <div class="user-details">
                    <div class="input-box">
                        <x-input-label for='building_name'>building_name</x-input-label>
                        <x-text-input value="{{ old('building_name', $buildings->building_name) }}" class="w-full"
                            name='building_name'></x-text-input>
                        @error('building_name')
                            <x-input-label for='building_name'
                    ...
                    <div class="input-box">
                        ...
                        <select name="camp_id">
                            ...
                            @foreach ($camp as $camp)
                                <option @selected($camp == $buildings->camp) value="{{ $camp->id }}">
                    ...
                    <div class="input-box">
                        ...
                        <select name="rooms_id">
                            ...
                            @foreach ($room as $room)
                                <option @selected($room == $buildings->room) value="{{ $room->id }}">
