            ...
            <div class="overflow-hidden">
                <table class="min-w-full text-center text-sm font-light">
                    ...
                    <tbody>
                        ...
                        <div class="container">
                            @forelse ($users_camps as $user_camp)
                                <tr class="border-b dark:border-neutral-500">
                                    ...
                                    <td class="whitespace-nowrap  px-6 py-4 font-medium">
                                        {{ $user_camp->phone_number }}
                                    </td>
                                    <td class="whitespace-nowrap  px-6 py-4 font-medium">
                                        {{ $user_camp->number_guests }}
                                    </td>
                                    <td class="whitespace-nowrap  px-6 py-4 font-medium">
                                        {{ $user_camp->city }}
                                    </td>
                                    <td class="whitespace-nowrap  px-6 py-4 font-medium">
                                        {{ $user_camp->entry_date }}
                                    </td>
                                    <td class="whitespace-nowrap  px-6 py-4 font-medium">
                                        {{ $user_camp->end_date }}
                                    </td>
                                    <td class="whitespace-nowrap  px-6 py-4 font-medium">
                                        {{ $user_camp->camp->camp_name }}
                                    </td>
                                    <td class="whitespace-nowrap  px-6 py-4 font-medium">
                                        {{ $user_camp->rooms->room_number }}
                                    </td>
                                    <td>
                                        <div class="icon-row">
                                            <div>
                                                <a href="{{ route('user_camp.edit', $user_camp->id) }}">
                                                    <i class="fa-solid fa-user-pen" style="color:blue"></i></a>
                                            </div>
                                            <div>
                                                <form method="post"
                                                    action="{{ route('user_camp.destroy', $user_camp->id) }}">
                                                    @csrf
                                                    @method('DELETE')
                ...
                <div class="flex justify-end p-1 m-0 ">
                    <button class="bg-blue-500 bg-blue-700 text-white font-bold py-2 px-4 rounded  flex justify-end">
                        <a href="{{ route('user_camp.create') }}">ADD NEW user_camp</a>
                    </button>
                </div>
                </tbody>
            </div>
